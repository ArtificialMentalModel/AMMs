...
args = TrainingArguments(
    output_dir="/netscratch/muhkhan/results/mistral_7b_ft",
    num_train_epochs=10,
...
# save model
trainer.save_model("mistral_7b_ft_10_model")
tokenizer.save_pretrained("mistral_7b_ft_10_model")
trainer.model.push_to_hub("mistral_7b_ft_10_model", token=os.getenv("HF_TOKEN", ""))
tokenizer.push_to_hub("mistral_7b_ft_10_model", token=os.getenv("HF_TOKEN", ""))
